...
def build_verifyLikedBook_test_case():
    dbBookcrossingTest = mysql.connector.connect(
    host="localhost",
    user="root",
    password="bcrs",
    ...
    case_books_values = [
      ('TestBook 1', 'TestAuthor 1', 'TestLanguage1', 'TestGender1', '1980', 'juan', 1),
      ('TestBook 2', 'TestAuthor 3', 'TestLanguage1', 'TestGender1', '1977', 'pedro', 2),
      ('TestBook 3', 'TestAuthor 3', 'TestLanguage1', 'TestGender2', '1965', 'pedro', 2),
    ]
...
def build_verifyMatch_test_case():
    dbBookcrossingTest = mysql.connector.connect(
    host="localhost",
    user="root",
    password="bcrs",
